...
void FillSpectrum_expobkg_doublegauss()
{
	book_hist();
...
//   gStyle->SetHistMinimumZero(kTRUE);
   ...
   char outputfile[200];
   sprintf(outputfile,"rootfiles/Dspectrum_pbpb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_expobkg_doublegauss.root", NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
