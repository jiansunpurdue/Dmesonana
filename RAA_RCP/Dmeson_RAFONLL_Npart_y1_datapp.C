void Dmeson_RAFONLL_Npart_y1_datapp()
{
	...
	TFile * input_cent0to10 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent0to10_ptbin7_y1_dataplusfonll.root");
	...
	TFile * input_cent10to30 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent10to30_ptbin7_y1_dataplusfonll.root");
	...
	TFile * input_cent30to50 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent30to50_ptbin7_y1_dataplusfonll.root");
	...
	TFile * input_cent50to100 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent50to100_ptbin7_y1_dataplusfonll.root");
	...
	D0_RAFONLL_4ptbin->SaveAs("results/D0_RAFONLL_7ptbin_cent0103050100_y1_dataplusfonll.png");
	D0_RAFONLL_4ptbin->SaveAs("results/D0_RAFONLL_7ptbin_cent0103050100_y1_dataplusfonll.pdf");
...
//		Npart_pt16to28[i]  = Npart_central[i] + 2.5 * step;
	...
	for( int i = 0; i < 4; i++ )
	{
		RAA_D0_pt3p5to4p5[i] = D0_fonll_raa_errordata[3-i]->GetY()[2];
		cout << " RAA_D0_pt3p5to4p5[i]: " << RAA_D0_pt3p5to4p5[i] << endl;
		RAA_D0_pt3p5to4p5_errordata_yl[i] = D0_fonll_raa_errordata[3-i]->GetErrorYlow(2);
		RAA_D0_pt3p5to4p5_errordata_yh[i] = D0_fonll_raa_errordata[3-i]->GetErrorYhigh(2);
		RAA_D0_pt3p5to4p5_errorfonll_yl[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYlow(2);
		RAA_D0_pt3p5to4p5_errorfonll_yh[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYhigh(2);
		RAA_D0_pt3p5to4p5_errorsys_yl[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYlow(2);
		RAA_D0_pt3p5to4p5_errorsys_yh[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYhigh(2);
		
		RAA_D0_pt4p5to7[i] = D0_fonll_raa_errordata[3-i]->GetY()[3];
		RAA_D0_pt4p5to7_errordata_yl[i] = D0_fonll_raa_errordata[3-i]->GetErrorYlow(3);
		RAA_D0_pt4p5to7_errordata_yh[i] = D0_fonll_raa_errordata[3-i]->GetErrorYhigh(3);
		RAA_D0_pt4p5to7_errorfonll_yl[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYlow(3);
		RAA_D0_pt4p5to7_errorfonll_yh[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYhigh(3);
		RAA_D0_pt4p5to7_errorsys_yl[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYlow(3);
		RAA_D0_pt4p5to7_errorsys_yh[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYhigh(3);

		RAA_D0_pt7to11[i] = D0_fonll_raa_errordata[3-i]->GetY()[4];
		RAA_D0_pt7to11_errordata_yl[i] = D0_fonll_raa_errordata[3-i]->GetErrorYlow(4);
		RAA_D0_pt7to11_errordata_yh[i] = D0_fonll_raa_errordata[3-i]->GetErrorYhigh(4);
		RAA_D0_pt7to11_errorfonll_yl[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYlow(4);
		RAA_D0_pt7to11_errorfonll_yh[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYhigh(4);
		RAA_D0_pt7to11_errorsys_yl[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYlow(4);
		RAA_D0_pt7to11_errorsys_yh[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYhigh(4);

		RAA_D0_pt11to16[i] = D0_fonll_raa_errordata[3-i]->GetY()[5];
		RAA_D0_pt11to16_errordata_yl[i] = D0_fonll_raa_errordata[3-i]->GetErrorYlow(5);
		RAA_D0_pt11to16_errordata_yh[i] = D0_fonll_raa_errordata[3-i]->GetErrorYhigh(5);
		RAA_D0_pt11to16_errorfonll_yl[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYlow(5);
		RAA_D0_pt11to16_errorfonll_yh[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYhigh(5);
		RAA_D0_pt11to16_errorsys_yl[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYlow(5);
		RAA_D0_pt11to16_errorsys_yh[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYhigh(5);

		RAA_D0_pt16to28[i] = D0_fonll_raa_errordata[3-i]->GetY()[6];
		RAA_D0_pt16to28_errordata_yl[i] = D0_fonll_raa_errordata[3-i]->GetErrorYlow(6);
		RAA_D0_pt16to28_errordata_yh[i] = D0_fonll_raa_errordata[3-i]->GetErrorYhigh(6);
		RAA_D0_pt16to28_errorfonll_yl[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYlow(6);
		RAA_D0_pt16to28_errorfonll_yh[i] = D0_fonll_raa_errorfonll[3-i]->GetErrorYhigh(6);
		RAA_D0_pt16to28_errorsys_yl[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYlow(6);
		RAA_D0_pt16to28_errorsys_yh[i] = D0_fonll_raa_errorsys[3-i]->GetErrorYhigh(6);
	}
...
//    pad1->cd();
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatex(0.15,0.65, "50-100%");
    Tl.DrawLatex(0.27,0.50, "30-50%");
    Tl.DrawLatex(0.46,0.37, "10-30%");
	Tl.DrawLatex(0.68,0.35, "0-10%");
//
//	pad2->cd();
...
//
	...
	D0_RAFONLL_Npart->SaveAs("results/D0_RAFONLL_Npart_cent0103050100_pt3p54p57112028_y1_dataplusfonll.png");
	D0_RAFONLL_Npart->SaveAs("results/D0_RAFONLL_Npart_cent0103050100_pt3p54p57112028_y1_dataplusfonll.pdf");
}
