void Dmeson_RCP_Centrality_8ptbin()
{
	...
	TFile * input_cent0to20 = new TFile("RCP_D0_PbPb_effunpre_cent0to20_ptbin8.root");
	D0_Rcp[0] = ( TH1D * ) input_cent0to20->Get("D0_Rcp");

	TFile * input_cent10to30 = new TFile("RCP_D0_PbPb_effunpre_cent10to30_ptbin8.root");
	D0_Rcp[1] = ( TH1D * ) input_cent10to30->Get("D0_Rcp");

	TFile * input_cent30to50 = new TFile("RCP_D0_PbPb_effunpre_cent30to50_ptbin8.root");
	D0_Rcp[2] = ( TH1D * ) input_cent30to50->Get("D0_Rcp");

	TCanvas * D0_RCP_8ptbin = new TCanvas("D0_RCP_8ptbin","D0_RCP_8ptbin");
	...
	t->SetFillColor(0);
	t->AddEntry(D0_Rcp[0], "Centrality 0-20%", "PL");
	t->AddEntry(D0_Rcp[1], "Centrality 10%-30%", "PL");
    t->AddEntry(D0_Rcp[2], "Centrality 30%-50%", "PL");
	t->Draw();

	D0_RCP_8ptbin->SaveAs("plots/D0_RCP_8ptbin_cent020103050.png");
	D0_RCP_8ptbin->SaveAs("plots/D0_RCP_8ptbin_cent020103050.pdf");
