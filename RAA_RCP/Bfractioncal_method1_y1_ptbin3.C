...
double *syserrorPer_fit = 999999.0;
...
//	cout << " bin width: " << BtoD_max_raa->GetBinWidth(10) << "    " << BtoD_central_raa->GetBinWidth(10) << "   " << BtoD_min_raa->GetBinWidth(10) << endl;
    ...
    //Rebin Edge
    double rebin[REBINp] = {1.5, 8.0, 16.0, 28.0};
    ...
    //bin middle
    double apt[REBIN] = { 4.75, 12.0, 22.0};//pPb_pt
    //bin half width
    double aptl[REBIN] = { 3.25, 4.0, 6.0};//pPb_pt
    double asigma[REBIN],aminall[REBIN],amaxall[REBIN],aerrorl[REBIN],aerrorh[REBIN];
    //number of every rebined bin
    double bin_num[REBIN] = { 26, 32, 48};//pPb_pt
...
void Bfractioncal_method1_y1_ptbin3()
{
	int cent_low = 0;
	int cent_high = 0;
    double NEVT = 0.0;
    ...
    TFile * input_data_raw = new TFile("./../Datamassspectrumfit/rootfiles/Dspectrum_pbpb_data_ptbin_5_ptd_unpreMBtrig_0_cent0to10_y1.root");
    TFile * input_mc_BtoDeff = new TFile("./../rootfiles/D0_PbPb_acc_eff_ptbin_5_ybin_6_Bfeeddown_FONLLweight_cent-0to10_RAAscale_y1_Ncollweight1.root");
    ...
    TFile * input_data_raw = new TFile("./../Datamassspectrumfit/rootfiles/Dspectrum_pbpb_data_ptbin_5_ptd_unpreMBtrig_0_cent10to20_y1.root");
    TFile * input_mc_BtoDeff = new TFile("./../rootfiles/D0_PbPb_acc_eff_ptbin_5_ybin_6_Bfeeddown_FONLLweight_cent10to20_RAAscale_y1_Ncollweight1.root");
    ...
    TFile * input_data_raw = new TFile("./../Datamassspectrumfit/rootfiles/Dspectrum_pbpb_data_ptbin_5_ptd_unpreMBtrig_0_cent20to30_y1.root");
    TFile * input_mc_BtoDeff = new TFile("./../rootfiles/D0_PbPb_acc_eff_ptbin_5_ybin_6_Bfeeddown_FONLLweight_cent20to30_RAAscale_y1_Ncollweight1.root");
    ...
    TFile * input_data_raw = new TFile("./../Datamassspectrumfit/rootfiles/Dspectrum_pbpb_data_ptbin_5_ptd_unpreMBtrig_0_cent30to40_y1.root");
    TFile * input_mc_BtoDeff = new TFile("./../rootfiles/D0_PbPb_acc_eff_ptbin_5_ybin_6_Bfeeddown_FONLLweight_cent30to40_RAAscale_y1_Ncollweight1.root");
    ...
    TFile * input_data_raw = new TFile("./../Datamassspectrumfit/rootfiles/Dspectrum_pbpb_data_ptbin_5_ptd_unpreMBtrig_0_cent40to50_y1.root");
    TFile * input_mc_BtoDeff = new TFile("./../rootfiles/D0_PbPb_acc_eff_ptbin_5_ybin_6_Bfeeddown_FONLLweight_cent40to50_RAAscale_y1_Ncollweight1.root");
    ...
    TFile * input_data_raw = new TFile("./../Datamassspectrumfit/rootfiles/Dspectrum_pbpb_data_ptbin_5_ptd_unpreMBtrig_0_cent50to100_y1.root");
    TFile * input_mc_BtoDeff = new TFile("./../rootfiles/D0_PbPb_acc_eff_ptbin_5_ybin_6_Bfeeddown_FONLLweight_cent50to100_RAAscale_y1_Ncollweight1.root");
