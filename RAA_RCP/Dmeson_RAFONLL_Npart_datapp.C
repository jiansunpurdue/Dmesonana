void Dmeson_RAFONLL_Npart_datapp()
{
	...
	TFile * input_cent0to10 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent0to10_ptbin5_dataplusfonll.root");
	...
	TFile * input_cent10to30 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent10to30_ptbin5_dataplusfonll.root");
	...
	TFile * input_cent30to50 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent30to50_ptbin5_dataplusfonll.root");
	...
	TFile * input_cent50to100 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent50to100_ptbin5_dataplusfonll.root");
	...
	D0_RAFONLL_4ptbin->SaveAs("results/D0_RAFONLL_5ptbin_cent0103050100_dataplusfonll.png");
	D0_RAFONLL_4ptbin->SaveAs("results/D0_RAFONLL_5ptbin_cent0103050100_dataplusfonll.pdf");
...
//    pad1->cd();
    ...
    Tl.SetTextAlign(12);
    Tl.SetTextSize(0.03);
    Tl.DrawLatex(0.15,0.68, "50-100%");
    Tl.DrawLatex(0.27,0.50, "30-50%");
    Tl.DrawLatex(0.46,0.35, "10-30%");
	Tl.DrawLatex(0.68,0.34, "0-10%");
//
//	pad2->cd();
...
//
	...
	D0_RAFONLL_Npart->SaveAs("results/D0_RAFONLL_Npart_cent0103050100_pt3p54p57112028_dataplusfonll.png");
	D0_RAFONLL_Npart->SaveAs("results/D0_RAFONLL_Npart_cent0103050100_pt3p54p57112028_dataplusfonll.pdf");
}
