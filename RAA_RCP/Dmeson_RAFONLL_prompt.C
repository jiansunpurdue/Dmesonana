...
void Draw_RAFONLL( TFile * input_pbpb, TFile * fonllinput, int cent_low, int cent_high, int Nptbin, double TAA)
{
	...
	D0_pbpb_spectrum->GetXaxis()->SetTitle("Prompt D0 p_{T} (GeV/c)");
...
//right way
	...
	D0_fonll_raa_errorfonll->GetYaxis()->SetTitle("Prompt D^{0} R^{FONLL}_{AA}");
	D0_fonll_raa_errorfonll->GetXaxis()->SetTitle("Prompt D^{0} p_{T} (GeV/c)");
    ...
    leg->AddEntry(D0_fonll_raa_errordata,"Prompt D^{0} R^{FONLL}_{AA}","PL");
    ...
    char cfgname[200];
	sprintf(cfgname,"plots/PromptD0_PbPb_spectrum_fonll_effunpre_cent%dto%d_ptbin%d.pdf",cent_low,cent_high, Nptbin);
	spectrum->SaveAs(cfgname);
	sprintf(cfgname,"plots/PromptD0_PbPb_spectrum_fonll_effunpre_cent%dto%d_ptbin%d.png",cent_low,cent_high, Nptbin);
	spectrum->SaveAs(cfgname);
	sprintf(cfgname,"plots/PromptRAAD0_PbPb_fonll_effunpre_cent%dto%d_ptbin%d.pdf",cent_low,cent_high, Nptbin);
	raadmeson->SaveAs(cfgname);
	sprintf(cfgname,"plots/PromptRAAD0_PbPb_fonll_effunpre_cent%dto%d_ptbin%d.png",cent_low,cent_high, Nptbin);
	raadmeson->SaveAs(cfgname);
