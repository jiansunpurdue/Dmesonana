...
double syserror_Per_FONLL = 4.2e-2;
...
//		cout << " RAA: " << D0_fonll_raa_errorsys->GetY()[i] << endl;
	...
	D0_fonll_raa_errordata->GetYaxis()->SetTitle("Prompt D^{0} R_{AA}");
    ...
    char cfgname[200];
	sprintf(cfgname,"results/PromptD0_PbPb_spectrum_fonll_effunpre_cent%dto%d_ptbin%d_dataplusfonll.pdf",cent_low,cent_high, Nptbin);
	spectrum->SaveAs(cfgname);
	sprintf(cfgname,"results/PromptD0_PbPb_spectrum_fonll_effunpre_cent%dto%d_ptbin%d_dataplusfonll.png",cent_low,cent_high, Nptbin);
	spectrum->SaveAs(cfgname);
	sprintf(cfgname,"results/PromptRAAD0_PbPb_fonll_effunpre_cent%dto%d_ptbin%d_dataplusfonll.pdf",cent_low,cent_high, Nptbin);
	raadmeson->SaveAs(cfgname);
	sprintf(cfgname,"results/PromptRAAD0_PbPb_fonll_effunpre_cent%dto%d_ptbin%d_dataplusfonll.png",cent_low,cent_high, Nptbin);
	raadmeson->SaveAs(cfgname);

	char outputfile[200];
	sprintf(outputfile, "rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent%dto%d_ptbin%d_dataplusfonll.root", cent_low,cent_high, Nptbin);
...
void Dmeson_RAFONLL_prompt_datapp()
{
   ...
   //centrality 0 to 100%
	  ...
	  fonllinput = new TFile("ppdatadrivenplusFONLL_10ptbin_y2.root");
   ...
   //Centrality 0 to 20%
      input_pbpb = new TFile("rootfiles/Prompt_Spectrum_centRecoeff_D0_PbPb_dpt_cent0to20_ptbin9.root");
	  fonllinput = new TFile("ppdatadrivenplusFONLL_10ptbin_y2.root");
...
////
   //centrality 0 to 10%
      input_pbpb = new TFile("rootfiles/Prompt_Spectrum_centRecoeff_D0_PbPb_dpt_cent0to10_ptbin5.root");
	  fonllinput = new TFile("ppdatadrivenplusFONLL_5ptbin_y2.root");
   ...
   //centrality 10 to 30%
      input_pbpb = new TFile("rootfiles/Prompt_Spectrum_centRecoeff_D0_PbPb_dpt_cent10to30_ptbin5.root");
	  fonllinput = new TFile("ppdatadrivenplusFONLL_5ptbin_y2.root");
   ...
   //centrality 30 to 50%
      input_pbpb = new TFile("rootfiles/Prompt_Spectrum_centRecoeff_D0_PbPb_dpt_cent30to50_ptbin5.root");
	  fonllinput = new TFile("ppdatadrivenplusFONLL_5ptbin_y2.root");
   ...
   //centrality 50 to 100%
      input_pbpb = new TFile("rootfiles/Prompt_Spectrum_centRecoeff_D0_PbPb_dpt_cent50to100_ptbin5.root");
	  fonllinput = new TFile("ppdatadrivenplusFONLL_5ptbin_y2.root");
