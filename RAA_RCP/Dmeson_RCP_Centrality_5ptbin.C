void Dmeson_RCP_Centrality_5ptbin()
{
	...
	TFile * input_cent0to10 = new TFile("RCP_D0_PbPb_effunpre_cent0to10_ptbin5.root");
	...
	TFile * input_cent10to30 = new TFile("RCP_D0_PbPb_effunpre_cent10to30_ptbin5.root");
	...
	TFile * input_cent30to50 = new TFile("RCP_D0_PbPb_effunpre_cent30to50_ptbin5.root");
...
//	col1->SetAlpha(0.2);
	...
	D0_RCP_5ptbin->SaveAs("results/D0_RCP_5ptbin_cent0103050100.png");
	D0_RCP_5ptbin->SaveAs("results/D0_RCP_5ptbin_cent0103050100.pdf");
