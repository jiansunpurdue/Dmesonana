...
void Dmeson_RAFONLL_Npart_y1_datapp_ptbin1pt8to16_nomodel_forQM()
{
...
//	col1->SetAlpha(0.7);
	...
	RAA_D0_pt8to16_errorsys_Npart->GetYaxis()->CenterTitle();
	RAA_D0_pt8to16_errorsys_Npart->GetYaxis()->SetTitleSize(0.05);
	RAA_D0_pt8to16_errorsys_Npart->GetXaxis()->SetTitleSize(0.05);
	RAA_D0_pt8to16_errorsys_Npart->GetXaxis()->SetLimits(0, 401);
	RAA_D0_pt8to16_errorsys_Npart->GetXaxis()->SetTitle("N_{part}");
	RAA_D0_pt8to16_errorsys_Npart->GetXaxis()->CenterTitle();
...
//
	...
	TLegend * tchargedhardon = new TLegend(0.50, 0.76, 0.80, 0.91);
	tchargedhardon->SetFillColor(0);
	tchargedhardon->SetTextSize(0.035);
	...
	TLegend * t = new TLegend(0.16, 0.71, 0.45, 0.91);
	t->SetFillColor(0);
	t->SetTextSize(0.035);
	t->SetTextFont(42);
...
//    t->AddEntry(RAA_D0_pt8to16_errorsys_Npart, "Syst._{} PbPb data+T_{AA}+N_{MB}+BR", "f");
	...
	TLegend * tnp = new TLegend(0.50, 0.57, 0.80, 0.69);
	tnp->SetFillColor(0);
	tnp->SetTextSize(0.035);
	tnp->SetTextFont(42);
	tnp->SetTextAlign(12);
...
//	Tl.DrawLatex(0.53,0.93, "PbPb #sqrt{s_{NN}} = 2.76 TeV");
    ...
    Tl.SetTextSize(0.04);
    Tl.SetTextFont(42);
    Tl.DrawLatex(0.125,0.96, "#scale[1.25]{CMS}");
    Tl.DrawLatex(0.24,0.96, "Preliminary");//->SetTextColor(kRed+2);
    Tl.DrawLatex(0.57,0.96, "PbPb #sqrt{s_{NN}} = 2.76 TeV");

	D0_RAFONLL_Npart->RedrawAxis();

//	D0_RAFONLL_Npart->SaveAs("results/D0_RAFONLL_Npart_ptbin1pt8to16_cent01020304050100_y1_dataplusfonll.png");
	D0_RAFONLL_Npart->SaveAs("D0_RAFONLL_Npart_ptbin1pt8to16_dataplusfonll_jpsi_chargedparticle_nomodel_forQM.pdf");
