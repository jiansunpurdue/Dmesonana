...
void DrawSigextforpas_modi_cent0to10()
{
  ...
  TFile* input = new TFile("./rootfiles/Dspectrum_pbpb_data_ptbin_14_ptd_unpreMBtrig_0_cent0to10_y1.root");
  TH1F* h[NPT];
  TString hname;
  ...
  */
  drawhistSep(h[2],2,ptbins[2],ptbins[3],1);
  drawhistSep(h[3],3,ptbins[3],ptbins[4],2);
  drawhistSep(h[4],4,ptbins[4],ptbins[5],3);
  drawhistSep(h[5],5,ptbins[5],ptbins[6],4);
  drawhistSep(h[6],6,ptbins[6],ptbins[7],5);
  drawhistSep(h[7],7,ptbins[7],ptbins[8],6);
  drawhistSep(h[8],8,ptbins[8],ptbins[9],7);
   drawhistSep(h[9],9,ptbins[9],ptbins[10],8);
   drawhistSep(h[10],10,ptbins[10],ptbins[11],9);
...
void drawhistSep(TH1F* histo, Int_t iptbin, Double_t ptmin, Double_t ptmax, Int_t ipad)
{
  ...
  if( iptbin == 12 ) hempty->SetMaximum(histo->GetMaximum()*1.55);
  hempty->Draw();
...
//
  ...
  tex = new TLatex(0.22,0.80,"Cent. 0-10%");
  tex->SetNDC();
  tex->SetTextFont(42);
  tex->SetTextSize(0.04);
  tex->SetLineWidth(2);
  ...
  cfg_sigextforpas_Sep->SaveAs(Form("massfitforpas/sigextforpas_%d_cent0to10.pdf",ipad));
  cfg_sigextforpas_Sep->SaveAs(Form("massfitforpas/sigextforpas_%d_cent0to10.png",ipad));
}
