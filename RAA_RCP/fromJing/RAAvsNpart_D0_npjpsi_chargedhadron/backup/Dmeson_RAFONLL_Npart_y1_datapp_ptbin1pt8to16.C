...
void Dmeson_RAFONLL_Npart_y1_datapp_ptbin1pt8to16()
{
  ...
  RAA_D0_pt8to16_errorsys_Npart->GetYaxis()->SetRangeUser(0, 1.7);
  ...
  RAA_npcharge_errorsys_Npart->SetFillColor(30);
  RAA_npcharge_errorsys_Npart->SetLineColor(30);
  RAA_npcharge_errorsys_Npart->Draw("2");
  RAA_npcharge_errordata_Npart->SetFillStyle(1001);
  RAA_npcharge_errordata_Npart->SetFillColor(30);
  RAA_npcharge_errordata_Npart->SetMarkerStyle(21);
  RAA_npcharge_errordata_Npart->SetMarkerSize(1.0);
  RAA_npcharge_errordata_Npart->SetLineColor(kGreen+3);
  RAA_npcharge_errordata_Npart->SetMarkerColor(kGreen+3);
  ...
  TLegend* t2 = new TLegend(0.12, 0.83, 0.45, 0.88);
  t2->SetFillColor(0);
  t2->SetBorderSize(0);
  ...
  t2->Draw();
  //t2->AddEntry((TObject*)0, "8.0 < p_{T} < 16.0 GeV/c, |y| < 1.0","");
  TLegend* t3 = new TLegend(0.12, 0.58, 0.45, 0.73);
  t3->SetFillColor(0);
  t3->SetBorderSize(0);
  ...
  tex = new TLatex(0.13,0.80,"8.0 < p_{T} < 16.0 GeV/c");
  tex->SetNDC();
  tex->SetTextFont(42);
  tex->SetTextSize(0.038);
  tex->SetLineWidth(2);
  tex->Draw();
  tex = new TLatex(0.13,0.75,"|y| < 1.0");
  tex->SetNDC();
  tex->SetTextFont(42);
  tex->SetTextSize(0.038);
  tex->SetLineWidth(2);
  ...
  TLegend* tnp = new TLegend(0.49, 0.83, 0.90, 0.88);
  tnp->SetFillColor(0);
  tnp->SetBorderSize(0);
  tnp->SetTextSize(0.038);
  tnp->SetTextFont(42);
  tnp->AddEntry(RAA_npjpsi_pt6p5to30_errordata_Npart, "Non-prompt J/#psi R_{AA}", "PL");
  tnp->Draw();
  //tnp->AddEntry((TObject*)0, "#scale[0.7]{6.5 < p_{T} < 30.0 GeV/c, |y| < 1.2}","");
  TLegend* tnp2 = new TLegend(0.49, 0.63, 0.90, 0.73);
  tnp2->SetFillColor(0);
  tnp2->SetBorderSize(0);
  tnp2->SetTextSize(0.038);
  tnp2->SetTextFont(42);
  tnp2->AddEntry(RAA_npjpsi_pt6p5to30_errorsys_Npart, "Syst.", "F");
  tnp2->AddEntry(g, "Syst. pp luminosity", "F");
  tnp2->Draw();

  tex = new TLatex(0.51,0.80,"6.5 < p_{T} < 30.0 GeV/c");
  tex->SetNDC();
  tex->SetTextFont(42);
  tex->SetTextSize(0.038);
  tex->SetLineWidth(2);
  tex->Draw();
  tex = new TLatex(0.51,0.75,"|y| < 1.2");
  tex->SetNDC();
  tex->SetTextFont(42);
  tex->SetTextSize(0.038);
  tex->SetLineWidth(2);
  ...
  TLegend* tchg = new TLegend(0.42, 0.51, 0.84, 0.56);
  tchg->SetFillColor(0);
  tchg->SetBorderSize(0);
  tchg->SetTextSize(0.038);
  tchg->SetTextFont(42);
  tchg->AddEntry(RAA_npcharge_errordata_Npart, "Charged particle R_{AA}", "PL");
  tchg->Draw();
  //tchg->AddEntry((TObject*)0, "#scale[0.7]{6.5 < p_{T} < 30.0 GeV/c, |y| < 1.2}","");
  TLegend* tchg2 = new TLegend(0.42, 0.41, 0.84, 0.46);
  tchg2->SetFillColor(0);
  tchg2->SetBorderSize(0);
  tchg2->SetTextSize(0.038);
  tchg2->SetTextFont(42);
  tchg2->AddEntry(RAA_npcharge_errorsys_Npart, "Syst.", "F");
  tchg2->Draw();

  tex = new TLatex(0.44,0.48,"7.2 < p_{T} < 9.6 GeV/c, |#eta| < 1.0");
  tex->SetNDC();
  tex->SetTextFont(42);
  tex->SetTextSize(0.038);
  tex->SetLineWidth(2);
