...
//		cout << "Pt: " << aCUJET10_pt[i] << "  RAA: " << aCUJET10_raa[i] << "   " << aCUJET20_raa[i] << "   " << aCUJET100_raa[i] << endl;
	}
	...
	gLBL10->Draw("lsame");
	TGraph* gCUJET10 = new TGraph(BIN_NUM_CUJET, aCUJET10_pt, aCUJET10_raa);
	gCUJET10->SetLineColor(12.0);
	gCUJET10->SetLineWidth(2);
	gCUJET10->Draw("lsame");
	...
	Traareference_cent0to10.DrawLatex(0.17,0.48, "Filled markers: data-extrapolated reference");
	...
	legThy10->AddEntry(gCUJET10,"CUJET3.0","l");
	legThy10->Draw("same");
	leg10->SetBorderSize(0);
	leg10->SetFillStyle(0);
	...
	gLBL20->Draw("lsame");
	l->Draw("same");
	TGraph* gCUJET20 = new TGraph(BIN_NUM_CUJET, aCUJET20_pt, aCUJET20_raa);
	gCUJET20->SetLineColor(12.0);
	gCUJET20->SetLineWidth(2);
	gCUJET20->Draw("lsame");
	...
	Traareference_cent0to20.DrawLatex(0.17,0.48, "Filled markers: data-extrapolated reference");
	...
	legThy20->AddEntry(gCUJET20,"CUJET3.0","l");
	legThy20->Draw("same");
	leg20->SetBorderSize(0);
	leg20->SetFillStyle(0);
	tex->Draw();
	...
	gLBL80->Draw("lsame");
	l->Draw("same");
	TGraph* gCUJET100 = new TGraph(BIN_NUM_CUJET, aCUJET100_pt, aCUJET100_raa);
	gCUJET100->SetLineColor(12.0);
	gCUJET100->SetLineWidth(2);
	gCUJET100->Draw("lsame");
	...
	Traareference_cent0to100.DrawLatex(0.17,0.48, "Filled markers: data-extrapolated reference");
	...
	legThy80->AddEntry(gCUJET100,"CUJET3.0","l");
	legThy80->Draw("same");
	leg80->SetBorderSize(0);
	leg80->SetFillStyle(0);
	tex->Draw();
