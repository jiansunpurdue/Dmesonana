...
void Alicecompare_cent0to20_dataplusfonll()
{
	...
	TFile * inputcms = new TFile("./../rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent0to20_ptbin9_dataplusfonll.root");
    ...
    leg->SetTextFont(62);
    leg->AddEntry(D0_fonll_raa_errordata,"CMS Preliminary R_{AA}, #left|y#right| < 2.0, Centrality 0-20%","PLf");
    ...
    cfg_alice_0to20->SaveAs("./alicecomparison/Comparison_alice_cent0to20_dataplusfonll.png");
    cfg_alice_0to20->SaveAs("./alicecomparison/Comparison_alice_cent0to20_dataplusfonll.pdf");
