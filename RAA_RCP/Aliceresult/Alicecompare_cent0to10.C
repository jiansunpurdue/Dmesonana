...
void Alicecompare_cent0to10()
{
	...
	TFile * inputcms = new TFile("./../PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent0to10_ptbin9.root");
    ...
    leg->SetTextFont(62);
    leg->AddEntry(D0_fonll_raa_errordata,"CMS Preliminary R^{FONLL}_{AA}, #left|y#right| < 2.0, Centrality 0-10%","PLf");
    ...
    cfg_alice_0to20->SaveAs("./alicecomparison/Comparison_alice_cent0to10.png");
    cfg_alice_0to20->SaveAs("./alicecomparison/Comparison_alice_cent0to10.pdf");
