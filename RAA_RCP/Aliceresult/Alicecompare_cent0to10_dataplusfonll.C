...
void Alicecompare_cent0to10_dataplusfonll()
{   
	...
	TFile * inputcms = new TFile("./../rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent0to10_ptbin9_dataplusfonll.root");
    ...
    cfg_alice_0to20->SaveAs("./alicecomparison/Comparison_alice_cent0to10_dataplusfonll.png");
    cfg_alice_0to20->SaveAs("./alicecomparison/Comparison_alice_cent0to10_dataplusfonll.pdf");
