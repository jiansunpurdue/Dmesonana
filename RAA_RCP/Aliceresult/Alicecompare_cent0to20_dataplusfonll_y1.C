...
void Alicecompare_cent0to20_dataplusfonll_y1()
{
	...
	TFile * inputcms = new TFile("./../rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent0to20_ptbin11_y1_dataplusfonll.root");
    ...
    cfg_alice_0to20->SaveAs("./alicecomparison/Comparison_alice_cent0to20_dataplusfonll_y1.png");
    cfg_alice_0to20->SaveAs("./alicecomparison/Comparison_alice_cent0to20_dataplusfonll_y1.pdf");
