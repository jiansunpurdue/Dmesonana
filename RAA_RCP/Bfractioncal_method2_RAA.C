...
void Bfractioncal_method2_RAA()
{
    ...
    TFile * inputprompt_raa = new TFile("PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent0to100_ptbin10.root");
	TGraphAsymmErrors * D0_fonll_raa_errordata = ( TGraphAsymmErrors *) inputprompt_raa->Get("D0_fonll_raa_errordata");
...
//    cfg_BtoDraa_central->SaveAs("plots/RAA_rebin_BtoD_centralvalue.pdf");
    ...
    for( int i = 0; i < REBIN; i++ )
    {
		...
		cout << " eff_BtoD: " << eff_BtoD << "    asigma_noraa: " << asigma_noraa[i] << "   RAA BtoD: " << Raa_BtoD_central_rebin->GetBinContent(i+1) << endl;
		cout << " eff_PromptD: " << eff_PromptD << "   prompt: " << d0fonllspectrum->GetY()[i] << "  RAA prompt: " << D0_fonll_raa_errordata->GetY()[i] << endl; 

        double ratio_BtoD_prompt = eff_BtoD * asigma_noraa[i] * Raa_BtoD_central_rebin->GetBinContent(i+1) 
		                          / ( eff_PromptD * d0fonllspectrum->GetY()[i] * D0_fonll_raa_errordata->GetY()[i] );
    ...
    cfg_Bfraction->SaveAs("plots/cfg_Bfraction_0to100_method2_raa.png");
    cfg_Bfraction->SaveAs("plots/cfg_Bfraction_0to100_method2_raa.pdf");
    ...
    cfg_Promptfraction->SaveAs("plots/cfg_Promptfraction_0to100_method2_raa.png");
    cfg_Promptfraction->SaveAs("plots/cfg_Promptfraction_0to100_method2_raa.pdf");
	...
	cfg_fraction->SaveAs("plots/cfg_fraction_0to100_method2_raa.png");
	cfg_fraction->SaveAs("plots/cfg_fraction_0to100_method2_raa.pdf");


    TFile * output = new TFile("Bfraction_method2_RAA.root", "RECREATE");
