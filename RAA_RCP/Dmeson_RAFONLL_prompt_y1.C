...
double syserrorPer_upper_ptbin12_cent0to100[12] = {0.217, 0.169, 0.165, 0.165, 0.156, 0.153, 0.158, 0.167, 0.160, 0.164, 0.173, 0.223};
double syserrorPer_lower_ptbin12_cent0to100[12] = {0.217, 0.169, 0.165, 0.165, 0.156, 0.153, 0.158, 0.167, 0.160, 0.164, 0.173, 0.223};

double syserrorPer_upper_ptbin11_cent0to10[11] = {0.246, 0.203, 0.195, 0.222, 0.209, 0.183, 0.202, 0.184, 0.204, 0.216, 0.185};
double syserrorPer_lower_ptbin11_cent0to10[11] = {0.246, 0.203, 0.195, 0.222, 0.209, 0.183, 0.202, 0.184, 0.204, 0.216, 0.185};

double syserrorPer_upper_ptbin11_cent0to20[11] = {0.250, 0.199, 0.207, 0.211, 0.199, 0.184, 0.198, 0.176, 0.194, 0.214, 0.198};
double syserrorPer_lower_ptbin11_cent0to20[11] = {0.250, 0.199, 0.207, 0.211, 0.199, 0.184, 0.198, 0.176, 0.194, 0.214, 0.198};
...
//		cout << " RAA: " << D0_fonll_raa_errorsys->GetY()[i] << endl;
    ...
    char cfgname[200];
	sprintf(cfgname,"results/PromptD0_PbPb_spectrum_fonll_effunpre_cent%dto%d_ptbin%d_y1.pdf",cent_low,cent_high, Nptbin);
	spectrum->SaveAs(cfgname);
	sprintf(cfgname,"results/PromptD0_PbPb_spectrum_fonll_effunpre_cent%dto%d_ptbin%d_y1.png",cent_low,cent_high, Nptbin);
	spectrum->SaveAs(cfgname);
	sprintf(cfgname,"results/PromptRAAD0_PbPb_fonll_effunpre_cent%dto%d_ptbin%d_y1.pdf",cent_low,cent_high, Nptbin);
	raadmeson->SaveAs(cfgname);
	sprintf(cfgname,"results/PromptRAAD0_PbPb_fonll_effunpre_cent%dto%d_ptbin%d_y1.png",cent_low,cent_high, Nptbin);
	raadmeson->SaveAs(cfgname);

	char outputfile[200];
	sprintf(outputfile, "rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent%dto%d_ptbin%d_y1.root", cent_low,cent_high, Nptbin);
...
void Dmeson_RAFONLL_prompt_y1()
{
   ...
   //centrality 0 to 100%
	  ...
	  fonllinput = new TFile("./../FONLL/fonll/outputDzero_y1.root");
   ...
   //centrality 0 to 10%
	  ...
	  fonllinput = new TFile("./../FONLL/fonll/outputDzero_y1_7ptbin_1p5to28.root");
