void Dmeson_RAFONLL_Npart_y1()
{
	...
	TFile * input_cent0to10 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent0to10_ptbin7_y1.root");
	...
	TFile * input_cent10to30 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent10to30_ptbin7_y1.root");
	...
	TFile * input_cent30to50 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent30to50_ptbin7_y1.root");
	...
	TFile * input_cent50to100 = new TFile("rootfiles/PromptRAA_D0_PbPb_spectrum_fonll_effunpre_cent50to100_ptbin7_y1.root");
	...
	D0_RAFONLL_4ptbin->SaveAs("results/D0_RAFONLL_7ptbin_cent0103050100_y1.png");
	D0_RAFONLL_4ptbin->SaveAs("results/D0_RAFONLL_7ptbin_cent0103050100_y1.pdf");
...
//    pad1->cd();
    ...
    Tl.DrawLatex(0.29,0.54, "30-50%");
    Tl.DrawLatex(0.48,0.42, "10-30%");
	Tl.DrawLatex(0.70,0.37, "0-10%");
//
//	pad2->cd();
...
//
	...
	D0_RAFONLL_Npart->SaveAs("results/D0_RAFONLL_Npart_cent0103050100_pt3p54p57112028_y1.png");
	D0_RAFONLL_Npart->SaveAs("results/D0_RAFONLL_Npart_cent0103050100_pt3p54p57112028_y1.pdf");
}
