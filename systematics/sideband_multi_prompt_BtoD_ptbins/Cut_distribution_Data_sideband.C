...
Data_input->Close();
   ...
   sprintf(outfilename, "Cut_distribution_Data_sideband_pt%.0fto%.0f_rapidity%.0fto%.0f_cent%2.0fto%2.0f_%dTo%d_cuts%d.root", Ptcut_low, Ptcut_high, rapidity_low, rapidity_high, hiBin_low * 0.5, hiBin_high * 0.5, startFile, endFile, nocuts);
