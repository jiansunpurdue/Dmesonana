...
//  h_mc_matched->GetXaxis()->SetLimits(min, max);
  ...
  c->SaveAs(Form("plots_pt7to40/var_mctruth_sideband_promptD_%s_pt7to40_tightcut.pdf",varname.Data()));
  c->SaveAs(Form("plots_pt7to40/var_mctruth_sideband_promptD_%s_pt7to40_tightcut.png",varname.Data()));
