...
void DrawComparison_sideband_matched_MC()
{
    ...
    TFile * input_mc = new TFile("filescent-0to30/Cut_distribution_MC_FONLLweight_Prompt_pt7to40_rapidity0to1_cent-0to30_sideband_dataptweight.root");
...
//	Drawvariable("ffls3d","decay length sig",input_mc, 0.0, 40, 20, outputfile);
	Drawvariable("alpha", "#alpha", input_mc, 0.0,0.2, 5 , outputfile);
