...
//  c_mass->SaveAs(Form("plots_pt7to40/varmass_bothsideband_%s_pt7_%s.pdf",varname.Data(),type.Data()));
//  c_mass->SaveAs(Form("plots_pt7to40/varmass_bothsideband_%s_pt7_%s.png",varname.Data(),type.Data()));
}
...
//  c->SaveAs(Form("plots_pt7to40/varcomparison_bothsideband_%s_pt7to40_tightcut_mcweightpt.pdf",varname.Data()));
//  c->SaveAs(Form("plots_pt7to40/varcomparison_bothsideband_%s_pt7to40_tightcut_mcweightpt.png",varname.Data()));
}
...
void DrawComparison_bothsideband_promptBtoD()
{
  ...
  gStyle->SetHistMinimumZero(kTRUE);
      ...
      TFile * input_data = new TFile("filespt7to40/Cut_distribution_Data_sideband_pt7to40_tightcut.root");
//	  TFile * input_mc_prompt = new TFile("filespt7to40/Cut_distribution_MC_FONLLweight_Prompt_pt7to40_sideband_weightpt.root");
//	  TFile * input_mc_BtoD = new TFile("filespt7to40/Cut_distribution_MC_FONLLweight_BtoD_pt7to40_sideband_weightpt.root");
      TFile * input_mc_prompt = new TFile("Cut_distribution_MC_pthatweight_Prompt_pt7to40_sideband.root");
	  TFile * input_mc_BtoD = new TFile("Cut_distribution_MC_pthatweight_BtoD_pt7to40_sideband.root");

//    Drawvariable("y","rapidity",input_data,input_mc_prompt, input_mc_BtoD, -2, 2, 4, -2, 2, -2, 2);
//    Drawvariable("ffls3d","decay length sig",input_data,input_mc_prompt, input_mc_BtoD, 0.0, 40, 20, 0, 1000, 4.5, 1000);
//	Drawvariable("alpha", "#alpha", input_data,input_mc_prompt, input_mc_BtoD, 0.0,3.14, 10, 0, 3.14, 0.0, 0.05);
//	Drawvariable("alpha", "#alpha", input_data,input_mc_prompt, input_mc_BtoD, 0.0,0.1, 2, 0, 3.14, 0.0, 0.10);
