...
void Cut_distribution_MC_matched_sideband()
{
	TH1::SetDefaultSumw2();
...
//               continue;
   ...
   char outputfile[200];
   if( isPrompt )
       sprintf(outputfile,"Cut_distribution_MC_FONLLweight_Prompt_pt%1.0fto%1.0f_sideband.root", Ptcut_low, Ptcut_high);
   else
       sprintf(outputfile,"Cut_distribution_MC_FONLLweight_BtoD_pt%1.0fto%1.0f_sideband.root", Ptcut_low, Ptcut_high);
