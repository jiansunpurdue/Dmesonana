...
$workarea = "$BASE/sl6ana/v1_pbpb_pp_pPb/CMSSW_5_3_20/src/UserCode/OpenHF/Dmesonana/systematics/sideband_multi_prompt_BtoD_ptbins";
...
sub produce_config_file {
    ...
    print OUTPUTFILE ("executable           = run_Cut_distribution_Data.sh\n");
	print OUTPUTFILE ("Arguments = $istart $iend $filelist\n");
