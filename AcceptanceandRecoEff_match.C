...
void book_hist()
{
    ...
    d0genpt->Sumw2(); d0genpt_acceptance->Sumw2(); d0candpt_matched->Sumw2();
	...
	d0geny->Sumw2(); d0geny_acceptance->Sumw2(); d0candy_matched->Sumw2();
    ...
    d0genypt->Sumw2();  d0genypt_acceptance->Sumw2(); d0candypt_matched->Sumw2();
}

void write_histo( TFile * output)
{
   output->cd();
   d0genpt->Write(); d0genpt_acceptance->Write();  d0candpt_matched->Write();
   d0geny->Write();   d0geny_acceptance->Write();   d0candy_matched->Write();
   d0genypt->Write(); d0genypt_acceptance->Write();  d0candypt_matched->Write();
}
...
void AcceptanceandRecoEff_match()
{
   ...
   TH1D * d0efficiency_pt = (TH1D *) d0candpt_matched->Clone("d0efficiency_pt");
   d0efficiency_pt->Divide(d0candpt_matched, d0genpt_acceptance, 1.0, 1.0, "B");
   ...
   TH1D * d0efficiency_y = (TH1D *) d0candy_matched->Clone("d0efficiency_y");
   d0efficiency_y->Divide(d0candy_matched, d0geny_acceptance, 1.0, 1.0, "B");
   ...
   TH2D * d0efficiency_ypt = ( TH2D *) d0candypt_matched->Clone("d0efficiency_ypt");
   d0efficiency_ypt->Divide(d0candypt_matched, d0genypt_acceptance, 1.0, 1.0, "B");
   ...
   TH1D * d0accxeff_pt = (TH1D *) d0candpt_matched->Clone("d0accxeff_pt");
   d0accxeff_pt->Divide(d0candpt_matched, d0genpt, 1.0, 1.0, "B");
   ...
   TH1D * d0accxeff_y = (TH1D *) d0candy_matched->Clone("d0accxeff_y");
   d0accxeff_y->Divide(d0candy_matched, d0geny, 1.0, 1.0, "B");
   ...
   TH2D * d0accxeff_ypt = ( TH2D *) d0candypt_matched->Clone("d0accxeff_ypt");
   d0accxeff_ypt->Divide(d0candypt_matched, d0genypt, 1.0, 1.0, "B");
   ...
   if( isPbPb )
   {
	   cfg_d0acceptance_pt->SaveAs("plots/D0_PbPb_acceptance_pt.pdf");
	   cfg_d0acceptance_pt->SaveAs("plots/D0_PbPb_acceptance_pt.png");
	   cfg_d0acceptance_y->SaveAs("plots/D0_PbPb_acceptance_y.pdf");
	   cfg_d0acceptance_y->SaveAs("plots/D0_PbPb_acceptance_y.png");
	   cfg_d0acceptance_ypt->SaveAs("plots/D0_PbPb_acceptance_ypt.pdf");
	   cfg_d0acceptance_ypt->SaveAs("plots/D0_PbPb_acceptance_ypt.png");

	   cfg_d0efficiency_pt->SaveAs("plots/D0_PbPb_efficiency_pt.pdf");
	   cfg_d0efficiency_pt->SaveAs("plots/D0_PbPb_efficiency_pt.png");
	   cfg_d0efficiency_y->SaveAs("plots/D0_PbPb_efficiency_y.pdf");
	   cfg_d0efficiency_y->SaveAs("plots/D0_PbPb_efficiency_y.png");
	   cfg_d0efficiency_ypt->SaveAs("plots/D0_PbPb_efficiency_ypt.pdf");
	   cfg_d0efficiency_ypt->SaveAs("plots/D0_PbPb_efficiency_ypt.png");

	   cfg_d0accxeff_pt->SaveAs("plots/D0_PbPb_accxeff_pt.pdf");
	   cfg_d0accxeff_pt->SaveAs("plots/D0_PbPb_accxeff_pt.png");
	   cfg_d0accxeff_y->SaveAs("plots/D0_PbPb_accxeff_y.pdf");
	   cfg_d0accxeff_y->SaveAs("plots/D0_PbPb_accxeff_y.png");
	   cfg_d0accxeff_ypt->SaveAs("plots/D0_PbPb_accxeff_ypt.pdf");
	   cfg_d0accxeff_ypt->SaveAs("plots/D0_PbPb_accxeff_ypt.png");
   }
   else
   {
	   cfg_d0acceptance_pt->SaveAs("plots/D0_pp_acceptance_pt.pdf");
	   cfg_d0acceptance_pt->SaveAs("plots/D0_pp_acceptance_pt.png");
	   cfg_d0acceptance_y->SaveAs("plots/D0_pp_acceptance_y.pdf");
	   cfg_d0acceptance_y->SaveAs("plots/D0_pp_acceptance_y.png");
	   cfg_d0acceptance_ypt->SaveAs("plots/D0_pp_acceptance_ypt.pdf");
	   cfg_d0acceptance_ypt->SaveAs("plots/D0_pp_acceptance_ypt.png");

	   cfg_d0efficiency_pt->SaveAs("plots/D0_pp_efficiency_pt.pdf");
	   cfg_d0efficiency_pt->SaveAs("plots/D0_pp_efficiency_pt.png");
	   cfg_d0efficiency_y->SaveAs("plots/D0_pp_efficiency_y.pdf");
	   cfg_d0efficiency_y->SaveAs("plots/D0_pp_efficiency_y.png");
	   cfg_d0efficiency_ypt->SaveAs("plots/D0_pp_efficiency_ypt.pdf");
	   cfg_d0efficiency_ypt->SaveAs("plots/D0_pp_efficiency_ypt.png");

	   cfg_d0accxeff_pt->SaveAs("plots/D0_pp_accxeff_pt.pdf");
	   cfg_d0accxeff_pt->SaveAs("plots/D0_pp_accxeff_pt.png");
	   cfg_d0accxeff_y->SaveAs("plots/D0_pp_accxeff_y.pdf");
	   cfg_d0accxeff_y->SaveAs("plots/D0_pp_accxeff_y.png");
	   cfg_d0accxeff_ypt->SaveAs("plots/D0_pp_accxeff_ypt.pdf");
	   cfg_d0accxeff_ypt->SaveAs("plots/D0_pp_accxeff_ypt.png");
   }
