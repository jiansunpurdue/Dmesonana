...
void FillSpectrum_doublecountedpoly2()
{
	book_hist();
...
//   gStyle->SetHistMinimumZero(kTRUE);
   ...
   char cfgname[200];
   sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_doublecountedpoly2.pdf",NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
   cfg_mb->SaveAs(cfgname);
   sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_doublecountedpoly2.gif",NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
   cfg_mb->SaveAs(cfgname);
  
   char outputfile[200];
   sprintf(outputfile,"rootfiles/Dspectrum_pbpb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_doublecountedpoly2.root", NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
