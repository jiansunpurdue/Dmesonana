...
double eff_fit_range_low[NPT] = {1.70, 1.78, 1.75, 1.72, 1.70, 1.70, 1.70, 1.70, 1.70, 1.70, 1.70, 1.70};
...
//    TF1* fit_fun = new TF1("fit_fun", "gausn(0) + pol2(3)", fit_range_low, fit_range_high);
    TF1* fit_fun = new TF1("fit_fun", "gausn(0) + pol1(3)", fit_range_low, fit_range_high);
...
//   gStyle->SetHistMinimumZero(kTRUE);
   ...
   char cfgname[200];
   sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_poly1bkg.pdf",NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
   cfg_mb->SaveAs(cfgname);
   sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_poly1bkg.gif",NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
   cfg_mb->SaveAs(cfgname);
  
   char outputfile[200];
   sprintf(outputfile,"rootfiles/Dspectrum_pbpb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_poly1bkg.root", NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
