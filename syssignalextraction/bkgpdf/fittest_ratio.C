void fittest_ratio()
{
	...
	TFile * input2 = new TFile("./rootfiles/Dspectrum_pbpb_data_ptbin_12_ptd_unpreMBtrig_0_cent-0to100_expobkg.root");
	TFile * input3 = new TFile("./rootfiles/Dspectrum_pbpb_data_ptbin_12_ptd_unpreMBtrig_0_cent-0to100_poly1bkg.root");
...
//	N_mb_fittest_linear->Draw("same");
    ...
    t->SetFillColor(0);
    t->AddEntry(N_mb_fittest_poly2, "Poly2 Bkg (Default)");
...
//	ratio_expo_poly2->SetLineColor(4.0);
	ratio_expo_poly2->GetYaxis()->SetTitle("Ratio to default");
	ratio_expo_poly2->GetYaxis()->SetRangeUser(0.8, 1.2);
