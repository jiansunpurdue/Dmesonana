...
//          fit_fun->SetParameter(3, effp0);
//          fit_fun->SetParameter(4, effp1);
//		  fit_fun->SetParameter(5, effp2);
//		  fit_fun->SetParameter(6, effNsigMC);
//          fit_fun->SetParLimits(3, effp0 - effp0error, effp0 + effp0error);
//          fit_fun->SetParLimits(4, 1.85, 1.875);
//          fit_fun->SetParLimits(5, 0.050, 0.20);
...
void FillSpectrum_floatdoublecountedpoly2()
{
	book_hist();
...
//   gStyle->SetHistMinimumZero(kTRUE);
   ...
   char cfgname[200];
   sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_floatdoublecountedpoly2.pdf",NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
   cfg_mb->SaveAs(cfgname);
   sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_floatdoublecountedpoly2.gif",NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
   cfg_mb->SaveAs(cfgname);
  
   char outputfile[200];
   sprintf(outputfile,"rootfiles/Dspectrum_pbpb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%2.0fto%2.0f_floatdoublecountedpoly2.root", NPT, evtunprescaleMB, hiBin_low * 0.5, hiBin_high * 0.5);
