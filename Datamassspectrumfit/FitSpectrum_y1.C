...
void drawcfg( int cent_low, int cent_high, int cfg_N_row, int cfg_N_column)
{
	...
	sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%dto%d_y%d_expobkg_doublegauss.pdf",NPT, evtunprescaleMB, cent_low, cent_high, rapidityrange);
	cfg_mb_expobkg->SaveAs(cfgname);
	sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%dto%d_y%d_expobkg_doublegauss.gif",NPT, evtunprescaleMB, cent_low, cent_high, rapidityrange);
	cfg_mb_expobkg->SaveAs(cfgname);
	...
	sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%dto%d_y%d_poly2bkg_doublegauss.pdf",NPT, evtunprescaleMB, cent_low, cent_high, rapidityrange);
	cfg_mb_poly2bkg->SaveAs(cfgname);
	sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%dto%d_y%d_poly2bkg_doublegauss.gif",NPT, evtunprescaleMB, cent_low, cent_high, rapidityrange);
	cfg_mb_poly2bkg->SaveAs(cfgname);
	...
	sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%dto%d_y%d_linearbkg_doublegauss.pdf",NPT, evtunprescaleMB, cent_low, cent_high, rapidityrange);
	cfg_mb_linearbkg->SaveAs(cfgname);
	sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%dto%d_y%d_linearbkg_doublegauss.gif",NPT, evtunprescaleMB, cent_low, cent_high, rapidityrange);
	cfg_mb_linearbkg->SaveAs(cfgname);
	...
	sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%dto%d_y%d_expobkg_floatwidth_doublegauss.pdf",NPT, evtunprescaleMB, cent_low, cent_high, rapidityrange);
	cfg_mb_expobkg_floatwidth->SaveAs(cfgname);
	sprintf(cfgname,"plots/D0_PbPb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%dto%d_y%d_expobkg_floatwidth_doublegauss.gif",NPT, evtunprescaleMB, cent_low, cent_high, rapidityrange);
	cfg_mb_expobkg_floatwidth->SaveAs(cfgname);
	...
	char outputfile[200];
	sprintf(outputfile,"rootfiles/Dspectrum_pbpb_data_ptbin_%d_ptd_unpreMBtrig_%d_cent%dto%d_y%d.root", NPT, evtunprescaleMB, cent_low, cent_high, rapidityrange);
...
void FitSpectrum_y1()
{
	...
	int cfg_N_column;
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_14_ptd_unpreMBtrig_0_cent-0to100_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_14_ptd_unpreMBtrig_0_cent-0to10_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_14_ptd_unpreMBtrig_0_cent-0to20_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_9_ptd_unpreMBtrig_0_cent-0to10_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_9_ptd_unpreMBtrig_0_cent10to30_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_9_ptd_unpreMBtrig_0_cent30to50_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_9_ptd_unpreMBtrig_0_cent50to100_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_3_ptd_unpreMBtrig_0_cent-0to10_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_3_ptd_unpreMBtrig_0_cent10to20_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_3_ptd_unpreMBtrig_0_cent20to30_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_3_ptd_unpreMBtrig_0_cent30to40_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
//
//	input = new TFile("./rootfiles/Masshisto_data_ptbin_3_ptd_unpreMBtrig_0_cent40to50_y1_tkpt1.0.root");
//	Gethisto( input );
//    for ( int i = 1; i < NPT -1 ; i++ )
//	{
//		if( hfg_minbias[i]->GetFunction("fit_fun") )
...
//
	...
	input = new TFile("./rootfiles/Masshisto_data_ptbin_3_ptd_unpreMBtrig_0_cent50to100_y1_tkpt1.0.root");
	Gethisto( input );
    for ( int i = 1; i < NPT -1 ; i++ )
	{
		if( hfg_minbias[i]->GetFunction("fit_fun") )
