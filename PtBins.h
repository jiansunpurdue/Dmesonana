...
//tmva cut
#define NCUTPT 11
const double cut_pt_edge[NCUTPT+1] = {0,3.5,4.5,5.5,7,9,11,13,16,20,28,40};
const double ffls3dcut[NCUTPT] = {3.98, 3.98, 3.98, 4.14, 3.87, 4.36, 3.68, 3.59, 3.25, 2.76, 3.18};
const double alphacut[NCUTPT]  = {0.065, 0.065, 0.065, 0.069, 0.053, 0.066, 0.075, 0.06, 0.061, 0.055, 0.133};
const double fprobcut[NCUTPT] = {0.082, 0.082, 0.082, 0.209, 0.113, 0.093, 0.057, 0.107, 0.025, 0.068, 0.020};
