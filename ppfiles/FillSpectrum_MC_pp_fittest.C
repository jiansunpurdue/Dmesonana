...
//    TF1* fit_fun = new TF1("fit_fun", fitfunction, cut_m_low, cut_m_high, 6);
    ...
    TF1* fit_fun = new TF1("fit_fun", "gausn(0) + gausn(3) + pol2(6)", cut_m_low, cut_m_high);
...
//		fit_fun->SetParameter(3, 0.6 * p0);
//		fit_fun->SetParameter(4, p1);
//		fit_fun->SetParameter(5, 8 * p2);
        fit_fun->FixParameter(3, 0.0);
		fit_fun->FixParameter(4, 0.0);
		fit_fun->FixParameter(5, 0.0);

        //.. fit constraint ..
        fit_fun->SetParLimits(0, p0_L, p0_H);
        fit_fun->SetParLimits(1, p1_L, p1_H);
        fit_fun->SetParLimits(2, p2_L, p2_H);
//		fit_fun->SetParLimits(3, p0_L, p0_H);
//		fit_fun->SetParLimits(4, p1_L, p1_H);
//		fit_fun->SetParLimits(5, 2 * p2_H, 10 * p2_H);

//		fit_fun->SetParLimits(3, 0., 0.);
//		fit_fun->SetParLimits(4, 0., 0.);
//		fit_fun->SetParLimits(5, 0., 0.);
...
//			histo->Fit(fit_fun,"WL","", cut_m_low, cut_m_high);
        ...
        TF1* fit_fun_doublecounting = (TF1*)fit_fun->Clone("fit_fun_doublecounting");
        fit_fun_doublecounting->SetParameter(0, 0);
        fit_fun_doublecounting->SetParameter(1, 0);
        fit_fun_doublecounting->SetParameter(2, 0);
		fit_fun_doublecounting->SetParameter(6, 0);
		fit_fun_doublecounting->SetParameter(7, 0);
		fit_fun_doublecounting->SetParameter(8, 0);
		fit_fun_doublecounting->SetLineColor(12);
		fit_fun_doublecounting->SetLineStyle(2);
//        fit_fun_doublecounting->Draw("same");
...
void FillSpectrum_MC_pp_fittest()
{
	book_hist();
...
//	   fit_fun->SetParameter(0, 1000);
//	   fit_fun->SetParameter(1, 1.864);
//	   fit_fun->SetParameter(2, 0.06);
//	   fit_fun->SetParLimits(1, 1.86, 1.87);
//	   fit_fun->SetParLimits(2, 0.04, 0.1);
//	   fit_fun->Draw("same");
	   hfg_minbias_MCdoublecounted[i]->DrawCopy("same");

	   cout << " i================" << i << "   matched signal: " << hfg_minbias_MCmatched[i]->Integral(1, massbin) << "   doulble counted signal: " <<  hfg_minbias_MCdoublecounted[i]->Integral(1, massbin) << "    ratio: " << hfg_minbias_MCdoublecounted[i]->Integral(1, massbin) / hfg_minbias_MCmatched[i]->Integral(1, massbin) << endl;
   ...
   TCanvas* cfg_doublecounted = new TCanvas("cfg_doublecounted", "cfg_doublecounted", 1000, 1000);
   cfg_doublecounted->Divide(3, 3);
...
//	   fit_fun->SetParLimits(2, 0.04, 0.1);
   ...
   char outputfile[200];
   sprintf(outputfile,"Dspectrum_pp_MC_genmatch_histo_ptbin_%d_fittest.root", NPT);
