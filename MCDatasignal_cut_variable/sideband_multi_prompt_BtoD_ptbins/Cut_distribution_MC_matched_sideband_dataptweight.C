...
void Cut_distribution_MC_matched_sideband_dataptweight()
{
	TH1::SetDefaultSumw2();
    ...
    TFile * input_fitteddata = new TFile("/home/sun229/DmesonAna/sl6ana/v1_pbpb_pp_pPb/CMSSW_5_3_20/src/UserCode/OpenHF/Dmesonana/recoeff_pthatweight_fonllweight/spectrumfitted_FONLLeff.root");
...
//               continue;
   ...
   char outputfile[200];
   if( isPrompt )
       sprintf(outputfile,"Cut_distribution_MC_FONLLweight_Prompt_pt%1.0fto%1.0f_sideband_dataptweight.root", Ptcut_low, Ptcut_high);
   else
       sprintf(outputfile,"Cut_distribution_MC_FONLLweight_BtoD_pt%1.0fto%1.0f_sideband_dataptweight.root", Ptcut_low, Ptcut_high);
