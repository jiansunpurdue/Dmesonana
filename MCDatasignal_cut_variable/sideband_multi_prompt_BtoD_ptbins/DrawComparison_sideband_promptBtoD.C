...
//	  TFile * input_mc_prompt = new TFile("filespt7to40/Cut_distribution_MC_FONLLweight_Prompt_pt7to40_sideband.root");
//	  TFile * input_mc_BtoD = new TFile("filespt7to40/Cut_distribution_MC_FONLLweight_BtoD_pt7to40_sideband.root");
